...
[^fox-ch6-conf]: See examples in Ch.6 of @Fox:2022aa.
...
- Naturally handles multivariable models and differential bias (condition on $W$ in step 2)
- The Fox et al. contingency-table route is one way to derive the per-record posterior — not the only way
