...
## Data Layout for Dichotomous Unmeasured Confounder {.smaller}
...
## What do we need? (1) Distribution of $Z$ by exposure {.smaller}
...
## What do we need? (2) Effect of $Z$ on $D$ {.smaller}
...
## What about the risk difference?[^11] {.smaller}
...
[^15]: See @McCullough:2022aa. I'll leave to to you as to whether you find this a convincing rebuttal.
