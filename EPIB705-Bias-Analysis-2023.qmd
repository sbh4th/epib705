...
-   Even if both exposure and disease are measured with 100% Sensitivity
    and 100% Specificity, if confounding is present misclassification of
    confounding variables may also lead to biased estimates.

- If the confounding is strong and the exposure-disease
    relation is weak or null, confounder misclassification can produce misleading results, even if independent and non-differential.

-   Example: Effect of coffee consumption on bladder cancer 
