...
## Relation between "true" and expected data

The number of individuals expected to be observed in a given study
is a function of the "true" exposure status and the bias parameters
...
- Truly unexposed individuals misclassified as exposed:
    $B(1-Sp_{D_{1}})$
