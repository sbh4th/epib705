...
-   Plugging in the estimates of $B_{11}$ and $B_{01}$ along with a
    ...
    $(OR_{DZ1}=OR_{DZ0}=5)$, assumed to be homogenous across strata of
...
-   Arah et al.^[See @Arah:2008aa] also given an alternative estimator using only 1) prevalence of $Z$ in each exposure stratum and 2) association between $Z$ and $D$
...
-   The crude association^[These data are derived from a case-control study, so this is just for illustration.] is $RD_{DX+}=(45/302)-(94/1039)=0.06$

-   Difference for $Z$ by exposure (70% $X=1$, 50% $X=0$)

-   [Choose]{style="color: red"} $RD$ for $Z-D$ among the unexposed as
    $RD_{DZ0}=0.10$.
